...
include '/virtual/htdocs/library/ApnsPHP/Autoload.php';

define('DB_DATABASE', 'app_kazuya');
define('DB_USER', 'app_kazuya');
define('DB_PASS', 'BWY6MKiT');
...
class iosPushNotifier {
    ...
    public function push(){
        //本番環境DB
        // $dsn    = 'mysql:dbname=app_kazuya;host=127.0.0.1';
        // $dbuser = 'app_kazuya';
        // $dbpass = 'BWY6MKiT';
      ...
      　       デバイストークンであるため削除）*/
            ...
            // $feedback = new ApnsPHP_Feedback(ApnsPHP_Abstract::ENVIRONMENT_SANDBOX, 'certificates_dev/server_certificates_sandbox.pem');
            $feedback = new ApnsPHP_Feedback(ApnsPHP_Abstract::ENVIRONMENT_PRODUCTION, dirname(__FILE__).'/certificates/server_certificates_production.pem');
            ...
            // $push = new ApnsPHP_Push(ApnsPHP_Abstract::ENVIRONMENT_SANDBOX, 'certificates_dev/server_certificates_sandbox.pem');
            $push = new ApnsPHP_Push(ApnsPHP_Abstract::ENVIRONMENT_PRODUCTION, dirname(__FILE__).'/certificates/server_certificates_production.pem');
